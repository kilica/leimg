...
/**
 * Leimg_AbstractAction
**/
abstract class Leimg_AbstractAction
{
	public /*** XCube_Root ***/ $mRoot = null;

	public /*** Leimg_Module ***/ $mModule = null;

	public /*** Leimg_AssetManager ***/ $mAsset = null;
