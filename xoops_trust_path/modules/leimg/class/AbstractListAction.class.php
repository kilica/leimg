...
/**
 * Leimg_AbstractListAction
**/
abstract class Leimg_AbstractListAction extends Leimg_AbstractAction
{
	public /*** XoopsSimpleObject[] ***/ $mObjects = null;

	public /*** Leimg_AbstractFilterForm ***/ $mFilter = null;
	...
	**/
	 ...
	 * @param	void
	 * 
	 * @return	&LeimgAbstractFilterForm
	**/
