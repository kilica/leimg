...
define('LEIMG_ADMIN_RENDER_TEMPLATE_DIRNAME','templates');
define('LEIMG_ADMIN_RENDER_FALLBACK_PATH',XOOPS_MODULE_PATH . '/legacy/admin/theme');    // TODO will be use other path
define('LEIMG_ADMIN_RENDER_FALLBACK_URL',XOOPS_MODULE_URL . '/legacy/admin/theme');    // TODO will be use other url

/**
 * Leimg_AdminRenderSystem
**/
class Leimg_AdminRenderSystem extends Legacy_AdminRenderSystem
{
    /**
     * prepare
     * 
    ...
    **/
    public function renderTheme(/*** XCube_RenderTarget ***/ &$target)
    {
        ...
        $info = Leimg_AdminRenderSystem::getOverrideFileInfo('admin_theme.html');
        $this->mSmarty->template_dir = ($info['file'] != null) ?
            substr($file['path'],0,-15) :
            LEIMG_ADMIN_RENDER_FALLBACK_PATH;
    ...
    **/
    ...
    {
        $info = Leimg_AdminRenderSystem::getOverrideFileInfo($target->getTemplateName());
    ...
    **/
    public static function getOverrideFileInfo(/*** string ***/ $file,/*** string ***/ $prefix = null,/*** bool ***/ $isSpDirName = false)
    {
        ...
        {
            $handler =& Leimg_Utils::getXoopsHandler('module');
        ...
        switch(true)
        {
            ...
            case $isModule && file_exists(
                ...
                $ret['dirname'] = $trustDirName;
                return $ret;
            case file_exists($path = LEIMG_ADMIN_RENDER_FALLBACK_PATH . '/' .$file):
                $ret['url'] = LEIMG_ADMIN_RENDER_FALLBACK_URL . '/' . $file;
                $ret['path'] = $path;
                $ret['theme'] = null;
                $ret['dirname'] = null;
                return $ret;
    ...
    **/
    ...
    {
        $info = Leimg_AdminRenderSystem::getOverrideFileInfo($str);
        if($info['url'] != null)
        {
            return $info['url'];
        }
        return LEIMG_ADMIN_RENDER_FALLBACK_URL . '/' . $str;
    }
    ...
    **/
    public static function functionStylesheet(/*** {string 'file',string 'media'} ***/ $param,/*** Smarty ***/ &$smarty)
    {
        ...
        $info = Leimg_AdminRenderSystem::getOverrideFileInfo($params['file'],'stylesheets/');
        if($info['file'] == null)
        {
            return;
        }
