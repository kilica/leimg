...
class Leimg_Updater
{
    ...
    **/
    ...
    {
        Leimg_InstallUtils::uninstallAllOfModuleTemplates($this->_mTargetXoopsModule,$this->mLog);
        Leimg_InstallUtils::installAllOfModuleTemplates($this->_mTargetXoopsModule,$this->mLog);
    }
    ...
    **/
    ...
    {
        Leimg_InstallUtils::smartUpdateAllOfBlocks($this->_mTargetXoopsModule,$this->mLog);
    }
    ...
    **/
    ...
    {
        Leimg_InstallUtils::smartUpdateAllOfConfigs($this->_mTargetXoopsModule,$this->mLog);
    }
    ...
    **/
    ...
    {
        $this->mLog->addReport(_MI_LEIMG_INSTALL_MSG_UPDATE_STARTED);
    ...
    **/
    public function saveXoopsModule(/*** XoopsModule ***/ &$module)
    {
        ...
        {
            $this->mLog->addReport(_MI_LEIMG_INSTALL_MSG_UPDATE_FINISHED);
        }
        else
        {
            $this->mLog->addError(_MI_LEIMG_INSTALL_ERROR_UPDATE_FINISHED);
        }
    }
    ...
    **/
    private function _processReport()
    {
        if(!$this->mLog->hasError())
        {
            $this->mLog->add(
                XCube_Utils::formatString(
                    _MI_LEIMG_INSTALL_MSG_MODULE_UPDATED,
        ...
        else
        {
            $this->mLog->add(
                XCube_Utils::formatString(
                    _MI_LEIMG_INSTALL_ERROR_MODULE_UPDATED,
                    $this->_mCurrentXoopsModule->get('name')
                )
            );
        }
